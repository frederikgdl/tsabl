...
public class TopicEnhancedTernaryHybridRankingMain {
    public static void train(HashMap<String, String> argsMap) throws Exception
    {
        ...
        int xTopics = argsMap.get("-topics");
...
//        }
        ...
        TopicEnhancedTernaryHybridRanking posMain = new TopicEnhancedTernaryHybridRanking(
                xWindowSize, vocabMap.size(), xHiddenSize, xEmbeddingLength, xTopics);

        Random rnd = new Random();
        posMain.randomize(rnd, -randomBase, randomBase);

        TopicEnhancedTernaryHybridRanking negMain = posMain.cloneWithTiedParams();
        ...
        for(int round = 0; round < trainRound; round++)
        {
            ...
            for(int fileIdx = 0; fileIdx < posFiles.size(); fileIdx++)
            {
                ...
                /*
                 * TODO: Add topic information to data
                 */
                ...
                for(int dataIdx = 0; dataIdx < trainingDatas.size(); dataIdx++)
                {
                    ...
                    for(int i = 0; i < data.words.length - xWindowSize + 1; i++)
                    {
                        ...
                        /*
                         * TODO: Add loss for topics
                         * TODO: Add topic information to data
                         * Add beta along alpha for weighting
                         */
