 ...
 */
public class OldTernaryHybridRanking {
    ...
    public OldTernaryHybridRanking()
    {
    }
    ...
    public OldTernaryHybridRanking cloneWithTiedParams() throws Exception
    {
        OldTernaryHybridRanking clone = new OldTernaryHybridRanking();
